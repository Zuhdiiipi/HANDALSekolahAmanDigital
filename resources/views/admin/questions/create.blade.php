                ...
                <div class="p-8 space-y-8">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select name="category_id"
                                    class="w-full pl-11 pr-4 py-3.5 bg-slate-50 border border-slate-200 text-slate-800 text-sm font-bold rounded-xl focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all appearance-none"
                                    required>
                    ...
                    <div>
                        ...
                        <div id="options-container" class="space-y-3">
                            @for ($i = 0; $i < 5; $i++)
                                <div
                                    class="option-row group flex gap-3 items-start bg-slate-50 p-2 rounded-2xl border border-slate-200 hover:border-indigo-200 transition-colors">
                                    <div
                                        class="w-10 h-[46px] flex items-center justify-center bg-white rounded-xl border border-slate-200 text-slate-400 font-bold text-sm shadow-sm">
                                        {{ $i + 1 }}
                                    </div>
                                    <div class="flex-grow">
                                    ...
                                    <div class="w-24 relative" title="Nilai Poin">
                                        ...
                                        <input type="number" name="options[{{ $i }}][score]"
                                            value="{{ $i + 1 }}"
                                            class="w-full pl-8 pr-3 py-3 bg-white border border-slate-200 rounded-xl text-sm font-bold text-center focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all"
                                            required>
                                    </div>
