            ...
            <div class="relative z-20 w-full flex flex-col justify-between p-16 text-white h-full">
                ...
                <div>
                    ...
                    <p class="text-blue-100 text-lg leading-relaxed max-w-md font-light">
                        Sistem terintegrasi untuk menciptakan ekosistem pendidikan yang aman, nyaman, dan terverifikasi
                        standar nasional.
                    </p>
                </div>
        ...
        <div class="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-20 xl:px-24 relative z-10 bg-white">
            ...
            <div class="mx-auto w-full max-w-sm lg:w-[26rem]">
                ...
                <div class="mb-8 text-center lg:text-left">
                    <img class="h-14 w-auto mb-6 mx-auto lg:mx-0 lg:hidden drop-shadow-sm"
                        src="{{ asset('img/Handal 8.png') }}" alt="Handal Logo">
                ...
                @if ($errors->any() || session('error'))
                    <div class="mb-6 bg-red-50 border border-red-100 text-red-600 px-4 py-3 rounded-xl flex items-start gap-3 shadow-sm"
                        role="alert">
                        <div class="mt-0.5">
                ...
                <form action="{{ route('login.post') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <i
                                    class="bi bi-envelope-fill text-slate-300 group-focus-within:text-blue-600 transition-colors"></i>
                            </div>
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <i
                                    class="bi bi-shield-lock-fill text-slate-300 group-focus-within:text-blue-600 transition-colors"></i>
                            </div>
                            ...
                            <button type="button" onclick="animateBlink()"
                                class="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-400 hover:text-blue-600 focus:outline-none transition-colors cursor-pointer z-10">
                                <i id="eyeIcon"
                                    class="bi bi-eye-slash text-lg inline-block origin-center transition-all duration-200 ease-in-out"></i>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between pt-2">
                        <div class="flex items-center">
                            ...
                            <label for="remember-me"
                                class="ml-2 block text-sm text-slate-600 cursor-pointer select-none font-medium">Ingat
                                saya</label>
                        </div>
                        <div class="text-sm">
                            <a href="#" class="font-bold text-blue-600 hover:text-blue-800 transition-colors">Lupa
                                password?</a>
                        </div>
                    </div>
                    ...
                    <div class="pt-2">
                        <button type="submit"
                            class="group w-full flex justify-center py-4 px-4 border border-transparent rounded-xl shadow-lg shadow-blue-900/20 text-sm font-bold text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600 transition-all duration-200 hover:-translate-y-1">
                ...
                <div class="mt-8 text-center">
                    ...
                    <a href="{{ route('registration.page') }}"
                        class="w-full flex items-center justify-center gap-2 py-3.5 px-4 border-2 border-slate-100 rounded-xl text-sm font-bold text-slate-600 bg-white hover:bg-slate-50 hover:border-slate-300 hover:text-blue-700 transition-all duration-200 group">
                        <i
                            class="bi bi-building-add text-lg text-slate-400 group-hover:text-blue-600 transition-colors"></i>
